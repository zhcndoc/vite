import{b as i,o as s,i as n,R as r,g as l,B as a}from"./chunks/framework.Caqowgrb.js";const p=`<svg viewBox="0 0 1896 1071" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,c=JSON.parse('{"title":"为什么选 Vite","description":"","frontmatter":{},"headers":[],"relativePath":"guide/why.md","filePath":"guide/why.md"}'),h={name:"guide/why.md"},g=Object.assign(h,{setup(f){return(d,e)=>{const t=i("svg-image");return s(),n("div",null,[e[0]||(e[0]=r("",10)),l(t,{svg:a(p)},null,8,["svg"]),l(t,{svg:a(o)},null,8,["svg"]),e[1]||(e[1]=r("",17))])}}});export{c as __pageData,g as default};
